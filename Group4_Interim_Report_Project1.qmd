...
After our initial proposal, we did exploratory analysis for each question. We decided to pursue question 1, which was “What factors are most impactful when predicting income?”. The process was to develop a full model and then run ANOVA to determine a viable reduced model. 
