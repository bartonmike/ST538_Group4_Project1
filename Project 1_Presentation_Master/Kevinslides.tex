...
\begin{frame}{Q3: Income vs Transportation}
    ...
    \begin{columns}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=.45\textwidth]{q3-income-v-commute-time-1}
          \caption{Income by Commute.}
          \label{fig 1: Income by Commute}
        \end{figure}
        
        \column{0.5\textwidth}
        \begin{figure}
          \centering
          \includegraphics[width=.45\textwidth]{q3-income-by-area-1}
          \caption{Income by Area.}
          \label{fig 2: Income by Area}
        \end{figure}
